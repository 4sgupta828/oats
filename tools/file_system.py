...
from core.workspace_security import secure_open, secure_read_text
...
@uf(name="read_file", version="1.0.0", description="Reads the content of a specified file.")
def read_file(inputs: ReadFileInput) -> str:
    ...
    print(f"Read {len(content)} characters from '{inputs.filename}'.")
    print(f"  → Location: {validated_path}")
    return content
